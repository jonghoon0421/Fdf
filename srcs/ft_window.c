...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/11/25 16:56:55 by jonkim            #+#    #+#             */
/*   Updated: 2017/11/29 20:16:25 by jonkim           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	keycode == 12 ? tot->angle_x += 0.1 : 0;
	keycode == 13 ? tot->angle_x -= 0.1 : 0;
	keycode == 0 ? tot->angle_y -= 0.1 : 0;
	keycode == 1 ? tot->angle_y += 0.1 : 0;
	keycode == 6 ? tot->angle_z -= 0.1 : 0;
	keycode == 7 ? tot->angle_z += 0.1 : 0;
	keycode == 27 ? tot->zoom -= 0.015 : 0;
	keycode == 24 ? tot->zoom += 0.015 : 0;
	keycode == 31 ? tot->z_scale += 3 : 0;
	keycode == 35 ? tot->z_scale -= 3 : 0;
}
